...
//        shardingJdbcJavaAPI.insertUser(dataSource);
    ...
    private Map<String, DataSource> createDataSource() {
        ...
        hikariDataSource1.setJdbcUrl("jdbc:mysql://localhost:3310/db_user");
        ...
        hikariDataSource2.setDriverClassName("com.mysql.cj.jdbc.Driver");
        hikariDataSource2.setJdbcUrl("jdbc:mysql://localhost:3311/db_user");
